      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center ml-20">
            <img 
              className="h-10 w-auto object-contain scale-[2.75]" 
              src="/logonew.png" 
              alt="Logo"
            />
          </div>
          ...
          {user?.token && (
            <div className="hidden md:flex items-center justify-end space-x-4 flex-1">
              <div className="relative">
                ...
                >
                  <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-[#F9C60A] flex-shrink-0">
                    <img
              ...
              <button 
                ...
                className="bg-[#F9C60A] hover:bg-orange-600 text-white rounded-lg px-4 py-2 flex items-center space-x-2 transition-colors duration-200"
              >
                <span>Sign Out</span>
          ...
          {user?.token ? (
            <div className="flex flex-col space-y-3">
              <div className="flex items-center space-x-3 p-2">
                <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-[#F9C60A]">
                  <img
              ...
              {/* <button 
                onClick={handleLogout}
                className="w-full bg-[#F9C60A] hover:bg-orange-600 text-white rounded-lg py-2 px-4 flex items-center justify-center space-x-2 transition-colors duration-200"
              >
                <span>Sign Out</span>
                <PiSignOutFill size={16} />
              </button> */}
            ...
            <Link href="/login">
              <div className="block w-full text-center py-2 px-4 text-[#F9C60A] hover:bg-orange-50 rounded-lg">
                Log In
              </div>
            </Link>
          )}
