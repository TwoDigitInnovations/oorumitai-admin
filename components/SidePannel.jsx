  ...
  return (
    <>
      <div className="xl:w-[280px] fixed top-0 left-0 z-20  md:w-[250px] sm:w-[200px] hidden sm:grid grid-rows-5  overflow-hidden">
        <div className="">
          <div className="bg-[#F9C60A] py-5 overflow-y-scroll h-screen  scrollbar-hide">
            <div
              className="bg-[#F9C60A] pt-5 pb-5 row-span-1 flex items-center justify-center cursor-pointer mx-5 rounded"
              onClick={() => router.push("/")}
            >
              {/* w-full pb-7*/}
              <img
      ...
      <div
        className={`w-full absolute top-0 left-0 z-40 sm:hidden flex flex-col h-screen max-h-screen overflow-hidden  bg-[#F9C60A] ${
