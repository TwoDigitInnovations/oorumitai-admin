    ...
    <div className="bg-gradient-to-b from-gray-50 to-white p-6 rounded-lg h-full shadow-lg max-w-4xl mx-auto py-8 md:my-12 my-4 overflow-y-scroll scrollbar-hide overflow-scroll pb-44 border border-gray-100">
      ...
      <div className="mb-6 border-b border-gray-200 pb-4">
        <h2 className="text-2xl font-bold text-gray-800 flex items-center">
          <span className="w-1 h-6 bg-[#F9C60A] rounded mr-3"></span>
          Create Flash Sales
        </h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          <button
            type="button"
            onClick={addSaleItem}
            className="bg-[#F9C60A] text-white py-2 px-4 rounded-lg hover:bg-[#e07016] transition-colors font-medium flex items-center"
          >
        ...
        {saleItems.map((item, index) => (
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
              <Clock className="h-5 w-5 mr-2 text-[#F9C60A]" />
              Sale Item #{index + 1}
            </h3>
            ...
            <div className="mb-4">
              <label className="block font-medium text-gray-700 mb-2 flex items-center">
                <ShoppingBag className="h-5 w-5 mr-2 text-[#F9C60A]" />
                Select Product
              </label>
              <Select
            ...
            {item.productDetails && (
              <div className="mb-4">
                ...
                <select
                  ...
                  className="block w-full border border-gray-300 rounded-lg shadow-sm p-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#F9C60A]/20 focus:border-[#F9C60A] transition-colors"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                <label className="block font-medium text-gray-700 mb-2 flex items-center">
                  <Calendar className="h-5 w-5 mr-2 text-[#F9C60A]" />
                  Start Date & Time
                </label>
                <input
                  type="datetime-local"
            ...
            <div className="mb-4">
              <label className="block font-medium text-gray-700 mb-2 flex items-center">
                <DollarSign className="h-5 w-5 mr-2 text-[#F9C60A]" />
                Sale Price
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="0.00"
                  step="0.01"
                  className="block w-full border border-gray-300 rounded-lg shadow-sm py-3 pl-8 pr-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#F9C60A]/20 focus:border-[#F9C60A] transition-colors"
                />
              </div>
            </div>
          </div>
        ...
        {saleItems.length > 0 && (
          <div className="relative">
            <button
              type="submit"
              className="w-full bg-[#F9C60A] text-white py-3 px-4 rounded-lg hover:bg-[#e07016] transition-colors font-medium flex items-center justify-center"
            >
            ...
            <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-[#F9C60A] opacity-50 rounded-full"></div>
          </div>
        )}
