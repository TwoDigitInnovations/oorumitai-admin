...
export default function Login(props) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFE27D] via-[#F9C60A] to-[#FFE27D] flex items-center justify-center p-4">
      {/* Background Pattern */}
        ...
        <div className="bg-white backdrop-blur-sm shadow-2xl rounded-3xl p-8 transform hover:scale-[1.02] transition-all duration-300">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mb-4">
              <div className="flex items-center space-x-2">
                <div className="bg-gradient-to-r from-[#FFE27D] to-[#F9C60A] p-2 rounded-xl">
                  <ShoppingCart className="w-8 h-8 text-white" />
                </div>
                <div className="text-left">
                  <img src="/logonew.png" className="h-32 w-full" />
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              onClick={submit}
              disabled={loading}
              className="w-full bg-[#F9C60A] hover:from-orange-600 hover:to-yellow-600 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 transform hover:scale-[1.02] focus:ring-4 focus:ring-orange-300 cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed shadow-lg"
            >
              {loading ? (
