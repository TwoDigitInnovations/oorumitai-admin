                ...
                <div className="w-full">
                    <div className="space-y-6">
                        ...
                        <div className="relative w-full">
                            ...
                            <div className="border border-gray-300 hover:border-[#F9C60A] transition-colors rounded-lg p-3 w-full bg-white flex justify-between items-center">
                                <input
                        ...
                        <div className="mt-6">
                            <button
                                ...
                                disabled={isLoading}
                                className="text-white bg-[#F9C60A]  hover:bg-orange-600 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors rounded-lg text-md font-medium py-2.5 px-6 shadow-sm"
                            >
                ...
                <div className="fixed inset-0 bg-black/30 bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
                        ...
                        <div className="flex justify-end space-x-3">
                            ...
                            <button
                                type="button"
                                className="px-4 cursor-pointer py-2 bg-[#F9C60A] text-white rounded-md hover:bg-orange-600 disabled:bg-gray-400 transition-colors"
