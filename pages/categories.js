      ...
      <section className="h-full overflow-y-scroll  scrollbar-hide overflow-scroll md:mt-0 mt-5 md:pb-32 pb-28">
        ...
        >
          ...
          <div className="flex justify-center items-center pt-5 pb-3">
            <button
              className="md:h-[45px] h-[40px] md:w-[274px] w-full bg-[#F9C60A] rounded-[10px] md:text-lg text-base text-white cursor-pointer font-semibold"
              type="submit"
            >
          ...
          >
            <div className="flex justify-between items-center w-full">
              ...
              <div className="flex justify-center items-center">
                <FiEdit
                  className="md:h-[30px] h-[20px] md:w-[30px] w-[20px] text-[#F9C60A] mr-[20px] cursor-pointer"
                  onClick={() => {
                    seteditid(item._id);
                    setData(item);
                ...
                <IoCloseCircleOutline
                  className="md:h-[30px] h-[20px] md:w-[30px] w-[20px] text-[#F9C60A] cursor-pointer"
