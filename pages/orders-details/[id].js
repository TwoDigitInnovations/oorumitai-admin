        ...
        <>
            <section className="w-full h-full bg-[#F9F9F9] py-6 px-4 md:px-8 overflow-scroll pb-20">
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <button className="bg-[#F9C60A] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#e07a25] transition-colors"
                ...
                <section className='bg-white rounded-xl shadow-sm overflow-hidden'>
                                    ...
                                    <div className='flex flex-row md:flex-col md:space-y-4 space-x-3 md:space-x-0 overflow-x-auto md:overflow-y-auto md:h-[400px] pb-4 md:pb-0'>
                                        {selectedImageList?.map((item, i) => (
                                            <div key={i} className='flex-shrink-0'>
                                                <div
                                                    className={`cursor-pointer rounded-lg overflow-hidden hover:shadow-md transition-all duration-200 ${selectedImage === item ? 'ring-2 ring-[#F9C60A]' : 'ring-1 ring-gray-200'}`}
                                                    onClick={() => {
                        ...
                        <div className='p-6 md:p-8'>
                            <div className='flex flex-col space-y-4'>
                                ...
                                <div className='flex items-center'>
                                    <span className='text-[#F9C60A] text-2xl font-bold'>${selecteSize?.rate || productsId?.price}</span>
                                </div>
                    ...
                    {/* <div className='px-6 pb-6 flex justify-between items-center'>
                        ...
                        <button className='bg-[#F9C60A] text-white px-6 py-3 rounded-lg text-sm font-medium hover:bg-[#e07a25] transition-colors'>
                            Track Order
                        </button>
                    </div> */}
                </section>
                ...
                {/* <div className='mt-8 px-4 py-6 bg-white rounded-xl shadow-sm'>
                    ...
                    <div className='relative'>
                        <div className='flex justify-between mb-2'>
                            <div className='text-[#F9C60A] font-medium'>Ordered</div>
                            <div className='text-[#F9C60A] font-medium'>Processing</div>
                            <div className='text-gray-400'>Shipped</div>
                            <div className='text-gray-400'>Delivered</div>
                        </div>

                        <div className='overflow-hidden h-2 mb-4 text-xs flex rounded bg-gray-200'>
                            <div style={{ width: '50%' }} className='shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-[#F9C60A]'></div>
                        </div>
                    </div>
                </div> */}
            </section>
