    ...
    try {
      const payload = {
        ...
        minShipmentCostForShipment:
          minshipmentCost !== "" ? parseFloat(minshipmentCost) : mincurrentShipmentCost,
        shipmentCostMessage:
          shipmentCostMessage !== ""
            ? shipmentCostMessage
      ...
      <section className="w-full bg-gray-50 md:p-8 p-4 h-[90vh] overflow-y-scroll  scrollbar-hide overflow-scroll pb-32">
        <div className="mb-8">
          <h2 className="text-gray-800 font-bold md:text-3xl text-2xl mb-4 flex items-center">
            <span className="w-1 h-8 bg-[#F9C60A] rounded mr-3"></span>
            Banner Management
          </h2>
            ...
            <form className="w-full" onSubmit={submit}>
              <div className="space-y-6">
                <div className="relative w-full">
                  ...
                  <div className="border border-gray-300 hover:border-[#F9C60A] transition-colors rounded-lg p-3 w-full bg-white flex justify-start items-center">
                    <input
                ...
                <div className="flex justify-between items-end gap-4">
                  ...
                  <button
                    type="button"
                    className="text-white bg-[#F9C60A] hover:bg-[#e47a1f] transition-colors rounded-lg text-md py-2.5 px-6 font-medium shadow-sm"
                    onClick={() => {
                      if (singleImg === "") {
                        props.toaster({
                          type: "error",
                ...
                <div className="mt-6">
                  <button
                    type="submit"
                    className="text-white bg-[#F9C60A] hover:bg-[#e47a1f] transition-colors rounded-lg text-md font-medium py-2.5 px-6 shadow-sm"
                  >
                    Submit
                  </button>
                </div>
              ...
              <div className="space-y-6">
                  ...
                  <div className="w-full">
                    ...
                    <div className="border border-gray-300 hover:border-[#F9C60A] transition-colors rounded-lg p-3 w-full bg-white flex justify-start items-center">
                      <input
                        ...
                        onChange={(e) => setMinLocalShippingCost(e.target.value)}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 flex-wrap">
                  <div className="bg-gray-50 p-4 rounded-lg md:flex md:gap-5">
                    ...
                    <button
                      type="button"
                      className="text-[#F9C60A] hover:text-[#e47a1f] font-medium text-sm flex items-center cursor-pointer"
                      onClick={() => {
                    ...
                    >
                      ...
                      <LiaEdit className="text-[#F9C60A] text-2xl mb-1" />
                    </button>
                  </div>
              ...
              <div className="space-y-6">
                <div className="w-full">
                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <button
                      type="submit"
                      className="text-white bg-[#F9C60A] hover:bg-[#e47a1f] transition-colors rounded-lg text-md font-medium py-2.5 px-6 shadow-sm whitespace-nowrap"
                    >
                      Add Zipcode
                    </button>
                  </div>
                            ...
                            <tr key={pincode._id} className="hover:bg-gray-50">
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-right text-sm">
                                <button
                                  ...
                                  className="text-[#F9C60A] hover:text-[#F9C60A] font-medium flex items-center justify-end gap-1 ml-auto cursor-pointer"
                                  type="button"
                                >
