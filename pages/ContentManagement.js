    ...
    <div className="w-full mx-auto p-4 bg-gray-50 mt-6 px-8">
      ...
      <div className="max-h-[80vh] h-full overflow-y-scroll  scrollbar-hide overflow-scroll pb-20 ">
        <div className="bg-white rounded-xl shadow-md overflow-hidden mb-6">
          <div className="p-6 border-l-4 border-[#F9C60A] flex flex-col md:flex-row items-center justify-between">
            <div className="w-full text-center md:text-left mb-4 md:mb-0">
              ...
              <h2 className="text-2xl md:text-3xl text-black font-bold mt-1">
                Welcome,{" "}
                <span className="text-[#F9C60A]">{user?.type || "Admin"}</span>
              </h2>
            </div>
            <div className="flex items-center gap-3">
              <button
                className={`py-2 px-6 rounded-lg transition-all duration-300 font-medium ${
                  tab === "CONTENT"
                    ? "bg-[#F9C60A] text-white shadow-lg shadow-orange-200"
                    : "bg-white border-2 text-[#F9C60A] border-[#F9C60A] hover:bg-orange-50"
                }`}
      ...
      <div className="bg-white rounded-t-xl shadow-md">
        <div className="p-5 border-b border-gray-100">
          <h3 className="text-xl text-black md:text-2xl font-bold flex items-center">
            <span className="inline-block w-3 h-8 bg-[#F9C60A] mr-3 rounded text-black"></span>
            {title}
          </h3>
        </div>
        ...
        <div className="p-4 md:p-6">
          <div className="border rounded-lg overflow-hidden">
            <div className="bg-gradient-to-r from-[#F9C60A] to-orange-400 h-2"></div>
          ...
          <div className="mt-4 flex justify-end">
            <button
              onClick={onSubmit}
              className="flex items-center gap-2 bg-[#F9C60A] hover:bg-orange-600 text-white font-medium py-2 px-6 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg"
            >
              <svg
