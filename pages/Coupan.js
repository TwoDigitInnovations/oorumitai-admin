      ...
      <section className="space-y-10">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-6">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                required
                className="bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-gray-900 text-sm focus:ring-2 focus:ring-[#F9C60A] focus:border-[#F9C60A] outline-none transition"
              />
            </div>
            ...
            <div className="flex items-center space-x-3 mt-4">
              <input
                ...
                className="h-5 w-5 accent-[#F9C60A]  focus:ring-[#F9C60A] border-gray-300 rounded cursor-pointer transition"
              />
          ...
          <div className="mt-8 flex justify-center">
            <button
              type="submit"
              className="bg-[#F9C60A] hover:bg-[#d46b19] text-white font-semibold text-lg rounded-xl px-14 py-3 transition-shadow shadow-md hover:shadow-lg focus:outline-none cursor-pointer "
            >
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-md p-5 mt-10">
          <input
            ...
            className="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-gray-900 text-base font-semibold focus:ring-2 focus:ring-[#F9C60A] focus:border-[#F9C60A] outline-none transition"
          />
        </div>
              ...
              >
                <div className="flex items-center space-x-4">
                  <input
                    ...
                    readOnly
                    className="h-6 w-6 accent-[#F9C60A] text-[#F9C60A] border-gray-300 rounded"
                  />
                  <div>
