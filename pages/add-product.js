            ...
            <div className="md:px-5 pb-5 bg-white h-full w-full boxShadow">
              <div className="grid md:grid-cols-2 grid-cols-1 w-full gap-5">
                ...
                <div className="">
                  ...
                  <div className="relative px-3 w-full bg-transparent border border-newblack rounded-[10px]">
                    <select
                      value={addProductsData.category?._id || addProductsData.category || ""}
                      onChange={(newValue) => {
              ...
              <div className="mt-8 p-6 bg-white rounded-xl border border-gray-200">
                ...
                <div className="flex w-full gap-4">
                  ...
                  <div
                    ...
                    className=" bg-[#F9C60A] text-white text-center text-[14px] md:text-lg font-medium md:h-13 h-12.5 md:py-3 py-4 px-4 rounded-md transition duration-300 w-1/3 cursor-pointer"
                  >
                    Generate
                  </div>
                </div>
              ...
              <div className="py-8 px-4">
                ...
                <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
                      ...
                      >
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <input
                              className="w-full bg-white border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 text-black focus:ring-[#F9C60A]/30 focus:border-[#F9C60A] transition-colors"
                              type="text"
                              value={slot.value}
                              onChange={(e) => {
                          ...
                          <div>
                            ...
                            <select
                              className="w-full bg-white border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#F9C60A]/30 focus:border-[#F9C60A] transition-colors text-black"
                              name="unit"
                              value={slot.unit}
                              required
                              onChange={(e) => {
                  ...
                  <div className="mt-6 flex justify-end">
                    <button
                      type="button"
                      className="bg-[#F9C60A] text-white px-6 py-3 rounded-lg font-medium flex items-center gap-2 hover:bg-[#F9C60A]/90 transition-colors"
                      onClick={() => {
                        setAddProductsData({
                          ...addProductsData,
                          price_slot: [
              ...
              <div className="flex md:flex-row flex-col justify-between items-center w-full pt-20 md:gap-0 gap-5">
                ...
                <div className="relative flex justify-center items-center md:w-auto w-full">
                  <button
                    className="bg-[#F9C60A] md:pr-8 md:h-[50px] h-[40px] md:w-[188px] w-full rounded-[5px] md:text-xl text-base text-white font-normal"
                    type="submit"
                  >
