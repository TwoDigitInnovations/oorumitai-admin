    ...
    <section className="w-full bg-gray-50 md:p-8 p-4 min-h-screen">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center mb-6">
          <div className="w-2 h-10 bg-[#F9C60A] rounded mr-4"></div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid md:grid-cols-2 grid-cols-1 gap-6">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                      <CiUser className="text-[#F9C60A] text-xl" />
                    </div>
                    <input
                      name="username"
                      className="bg-white w-full h-12 pl-12 pr-4 border border-gray-300 rounded-lg text-gray-800 outline-none focus:border-[#F9C60A] focus:ring-2 focus:ring-[#F9C60A]/20"
                      type="text"
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                      <CiMail className="text-[#F9C60A] text-xl" />
                    </div>
                    <input
                      name="email"
                      className="bg-white text-gray-800  w-full h-12 pl-12 pr-4 border border-gray-300 rounded-lg outline-none focus:border-[#F9C60A] focus:ring-2 focus:ring-[#F9C60A]/20"
                      type="email"
                ...
                {!router.query.id && (
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                        <CiLock className="text-[#F9C60A] text-xl" />
                      </div>
                      <input
                        name="password"
                        className="bg-white text-gray-800  w-full h-12 pl-12 pr-4 border border-gray-300 rounded-lg outline-none focus:border-[#F9C60A] focus:ring-2 focus:ring-[#F9C60A]/20"
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                      <CiPhone className="text-[#F9C60A] text-xl" />
                    </div>
                    <input
                      name="number"
                      className="bg-white w-full h-12 pl-12 pr-4 border border-gray-300 rounded-lg outline-none text-gray-800  focus:border-[#F9C60A] focus:ring-2 focus:ring-[#F9C60A]/20"
                      type="tel"
              ...
              <div className="mt-12 flex flex-col md:flex-row justify-end gap-4">
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto px-8 py-3 bg-[#F9C60A] text-white font-medium rounded-lg hover:bg-[#e07016] flex items-center gap-2"
                >
