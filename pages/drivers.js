              ...
              <div className="md:h-12">
                <div className="flex  mt-5  justify-center  gap-5">
                  {popupData?.status != "Verified" && (
                    <button
                      className="text-white text-lg font-bold w-[274px] h-[50px] rounded-[12px] bg-[#F9C60A]"
                      onClick={() => {
                  ...
                  {popupData?.status != "Suspended" && (
                    <button
                      className="text-white cursor-pointer text-lg font-bold w-[274px] h-[50px] rounded-[12px] bg-[#F9C60A]"
                      onClick={() => {
