              ...
              <ResponsiveContainer width="100%" height="90%">
                ...
                >
                  ...
                  <Tooltip
                    ...
                    labelStyle={{ color: "#F9C60A" }}
                  />

                  <Legend fill="#F9C60A" />
                  <Bar dataKey="monthly" fill="#F9C60A" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div className="py-4 h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  />
                  <Legend fill="#1F2937" />
                  <Bar dataKey="sold" fill="#F9C60A" radius={[4, 4, 0, 0]} />
                  <Bar
                    dataKey="remaining"
                    fill="#8884d8"
                    radius={[4, 4, 0, 0]}
...
const StatsCard = ({ title, value, icon, change }) => {
  return (
    <div className="bg-white rounded-xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md border-b-4 border-[#F9C60A]">
      <div className="p-5">
