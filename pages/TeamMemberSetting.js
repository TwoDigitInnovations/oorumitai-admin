        ...
        <div className="w-full">
          <div className="space-y-6">
            ...
            <div className="relative w-full">
              ...
              <div className="border border-gray-300 hover:border-[#F9C60A] transition-colors rounded-lg p-3 w-full bg-white">
                <input
                  className="outline-none bg-transparent w-full text-gray-700"
                  type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
              {teamMembers?.map((member, i) => (
                <div
                  key={i}
                  className="relative group bg-gray-50 rounded-lg p-4 border border-gray-200 hover:border-[#F9C60A] transition-colors"
                >
                  <div className="flex flex-col items-center">
                    ...
                    <div className="flex gap-2">
                      <button
                        type="button"
                        className="bg-[#F9C60A]  text-white p-2 rounded-md transition-colors"
                      ...
                      <button
                        type="button"
                        className="bg-[#F9C60A] text-white p-2 rounded-md transition-colors cursor-pointer"
