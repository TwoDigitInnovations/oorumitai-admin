              ...
              <>
                {isCompleted ? (
                  ...
                  <>
                    {!inProcess ? (
                      <button
                        className="px-4 py-1.5 bg-[#F9C60A] text-white text-[15px] cursor-pointer font-normal rounded-[8px]"
              ...
              <>
                ...
                {order.status !== "Return Requested" &&
                  ...
                  (order.status === "Completed" ? (
                    ...
                    <button className="px-4 py-1.5 bg-[#F9C60A] text-white text-[15px] cursor-pointer font-normal rounded-[8px]">
                      Order Shipped
                    </button>
                  ) : (
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                />
                <Search className="absolute left-3 top-3 h-4 w-4 text-[#F9C60A]" />
                {orderId && (
                  <button
                    onClick={() => setOrderId("")}
                    className="absolute right-3 top-3 text-gray-400 hover:text-gray-600"
                  >
                    <XCircle className="h-4 w-4 text-[#F9C60A]" />
                  </button>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                <Calendar className="absolute left-3 top-3 h-4 w-4 text-[#F9C60A]" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 max-w-md w-full shadow-lg flex flex-col">
              ...
              <div className="flex justify-end space-x-4">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-md bg-[#F9C60A] text-white hover:bg-[#F9C60A] transition cursor-pointer"
                >
                  Submit
                </button>
              </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-auto">
                        <p className="text-[#F9C60A] font-semibold">
                          $
                          {Number(item?.total) > 0 ? Number(item?.total || 0)?.toFixed(2) : ((Number(item?.price) * Number(item?.qty)) || 0).toFixed(2)}
                        </p>
                      </div>
                    </div>
                    {item?.BarCode && (
                  ...
                  {cartData?.isShipmentDelivery && (
                    <>
                      ...
                      {cartData?.status === "Shipped" && (
                        <div className="flex mt-3 justify-center items-center w-full bg-[#F9C60A] rounded-lg">
                          <button
                    ...
                    <div className="flex justify-end mt-2 mb-4">
                      {cartData?.SecretCode &&
                        (cartData?.isDriveUp || cartData?.isOrderPickup) && (
                          <button
                            className="bg-[#F9C60A] px-6 py-2 rounded-lg text-white font-medium shadow-sm hover:bg-[#e07a25] transition-colors"
                            onClick={() => {
                              setShowModal(true);
                              setOpenCart(false);
                              setId(cartData._id);
                      ...
                      {cartData?.status !== "Completed" && (
                        <button
                          className="bg-[#F9C60A] ml-2 px-6 py-2 rounded-lg text-white font-medium shadow-sm  transition-colors"
                      ...
                      {cartData?.isLocalDelivery && (
                        <button
                          className="w-48 ml-2 bg-[#F9C60A] px-6 py-2 rounded-lg text-white font-medium shadow-sm  transition-colors"
                  ...
                  <div className="mt-2 flex justify-end">
                    {isEditing ? (
                      <button
                        ...
                        className="px-4 py-2 bg-[#F9C60A] text-white rounded-md "
                      >
                        Add Note
                      </button>
                    ) : (
                      <button
                        ...
                        className="px-4 py-2 bg-[#F9C60A] text-white rounded-md hover:bg-[#F9C60A]"
                      >
                        Edit Note
                      </button>
                    )}
                  ...
                  <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 px-4">
                    <div className="bg-white rounded-xl shadow-lg w-full max-w-md overflow-hidden">
                      ...
                      <div className="flex justify-end gap-3 mt-6 p-4">
                        ...
                        <button
                          // type="submit"
                          className="px-4 py-2 bg-[#F9C60A] text-white rounded-lg hover:bg-orange-600 flex items-center gap-2 cursor-pointer"
          ...
          <div className="fixed inset-0 bg-black/30 bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg w-96">
              ...
              <div>
                ...
                />
                <button
                  className="w-full bg-[#F9C60A] cursor-pointer text-white py-2 rounded "
